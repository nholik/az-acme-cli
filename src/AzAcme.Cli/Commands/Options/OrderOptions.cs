...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        [Option("aws-access-key", Required = false, HelpText = "AWS Access Key ID. Required when using AWS Route53 DNS provider. If not set, will use AWS_ACCESS_KEY environment variable.")]
        public string AwsAccessKey
        {
            get
            {
                ...
                {
                    return Environment.GetEnvironmentVariable("AWS_ACCESS_KEY") ?? string.Empty;
                }
        ...
        [Option("aws-secret-key", Required = false, HelpText = "AWS Secret Access Key. Required when using AWS Route53 DNS provider. If not set, will use AWS_SECRET_KEY environment variable.")]
        public string AwsSecretKey
        {
            get
            {
                ...
                {
                    return Environment.GetEnvironmentVariable("AWS_SECRET_KEY") ?? string.Empty;
                }
        ...
        [Option("aws-region", Required = false, Default = "us-east-1", HelpText = "AWS Region. Required when using AWS Route53 DNS provider.")]
        public string AwsRegion { get; set; } 

        [Option("aws-zone-id", Required = false, HelpText = "AWS Route53 Hosted Zone ID. Required when using AWS Route53 DNS provider.")]
        public string AwsZoneId { get; set; }
